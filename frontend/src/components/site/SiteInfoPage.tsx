...
const SiteInfoPage: React.FC = () => {
  ...
  const dashboardStats = [
    ...
    { label: 'Test Environment', value: data.stats.testEnvironment, icon: <Layout className="w-5 h-5" /> },
    { label: 'Schedule Test Case', value: data.stats.scheduleTestCase, icon: <Calendar className="w-5 h-5" /> },
  ]
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="border border-[#E4D7D7] bg-white rounded-[6px] overflow-hidden shadow-none">
            <div className="bg-[#FFF8F8] border-b border-[#E4D7D7] py-3 px-4">
              <h2 className="text-[15px] font-semibold text-[#322525]">
                Analyze Process
              </h2>
            </div>
            <div className="p-5">
              <div className="flex items-center justify-between gap-4">
                <div className="flex flex-col gap-3">
                  <p className="text-sm text-[#7A6060] font-medium">
                    Processing...
                  </p>
                ...
                {dashboardStats.map((stat) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      <span className="text-xs font-medium text-[#8B6E6E] mb-0.5">
                        {stat.label}
                      </span>
                      <span className="text-2xl font-bold text-[#2B1F1F]">
                        {stat.value}
                      </span>
                    </div>
                  </div>
